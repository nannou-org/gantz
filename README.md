...
| **`gantz_rng`** | [![Crates.io](https://img.shields.io/crates/v/gantz_rng.svg)](https://crates.io/crates/gantz_rng) | ![MIT OR Apache-2.0](https://img.shields.io/badge/license-MIT_OR_Apache--2.0-blue.svg) | Seeded, stateless random numbers as a Steel module. |
