...
## [0.4.3](https://github.com/nannou-org/gantz/compare/gantz_format-v0.4.2...gantz_format-v0.4.3) - 2026-09-26
...
- *(gantz_format)* read a keyword's list value in sugar
- *(gantz_pattern)* add pplot keyword sugar

### Other

- *(gantz_format)* expose line_col
...
- *(gantz_format)* add #:require expr sugar for steel module deps
...
- *(format)* optional ext datum on ref specs
...
- *(core,format)* relocate the Datum value tree to gantz_core
