...
use gantz_core::node::{self, Node, Fn, Apply, WithPullEval};
...
impl node::fn_::NodeRegistry for TestEnv {
...
trait DebugNode: Debug + Node<TestEnv> {}
impl<T> DebugNode for T where T: Debug + Node<TestEnv> {}
