...
## [0.5.3](https://github.com/nannou-org/gantz/compare/bevy_gantz-v0.5.2...bevy_gantz-v0.5.3) - 2026-09-26

### Other

- updated the following local packages: gantz_core
...
## [0.5.1](https://github.com/nannou-org/gantz/compare/bevy_gantz-v0.5.0...bevy_gantz-v0.5.1) - 2026-08-26

### Added

- *(bevy_gantz)* add the SteelModules domain-contribution resource
- *(bevy_gantz)* add task module for async graph values
...
- *(bevy_gantz)* ChangedEvent carries old/new commit addrs
- *(bevy_gantz)* preserve node state across undo/redo and navigation
- *(gantz)* order-insensitive log layer, document assembly
- *(bevy,egui)* order-insensitive EntrypointFns seeding
