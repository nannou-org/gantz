...
- *(gantz_pattern)* add pat/map-events and the pmapevents graph
- *(gantz_pattern)* add pat/indices and the pindices graph
...
- *(gantz_pattern)* build pat/pure from a per-cycle helper
